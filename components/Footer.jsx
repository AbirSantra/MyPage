  ...
  return (
    <div className="w-full  flex justify-center items-center pb-8">
      ...
      <div className="w-full max-w-[1440px] flex flex-col gap-6 justify-center items-center px-4 md:px-8 lg:px-16">
        ...
        <Link href="/">
          <h1 className="navbar__logo font-Titillium text-[1.8rem] font-semibold leading-none dark:text-white-one mt-4">
            Abir<span className=" font-thin cursor-pointer ">Santra</span>
            <span className="text-main-dark font-bold">.</span>
          </h1>
        </Link>
        <Socials />
        <p className="text-light-grey text-sm font-normal text-center">
          Handcrafted by Abir Santra &copy; {new Date().getFullYear()} using
          NextJS | TailwindCSS | Sanity CMS
        </p>
      </div>
    </div>
  );
